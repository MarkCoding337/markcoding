...
class mainGame extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('bullet', 'https://cdn.glitch.global/27dc39f2-c1ed-4431-8f86-a125544d68da/bullet.png?v=1724436476823', {frameWidth: 16, frameHeight: 32});
    this.load.spritesheet('bullet2', 'https://cdn.glitch.global/27dc39f2-c1ed-4431-8f86-a125544d68da/bullet2.png?v=1724436696601', {frameWidth: 32, frameHeight: 16});
    this.load.spritesheet('enemy1', 'https://cdn.glitch.global/f49a979c-6b64-4401-b885-22d8de95245f/child.png?v=1715087777924', {frameWidth: 104, frameHeight: 104});
...
// Logging the first array as an example
    ...
    class Baddie extends Phaser.GameObjects.Sprite
        {
            ...
            hurt(amt)
          {
            if(this.immune == false) {
              ...
              gameVars.timeVar.delayedCall(250, () => {this.immune = false; this.alpha = 1; this.setTint("0xFFFFFF");});
            }
            //console.log(this);
          }
    ...
    gameVars.weaponIndicator = this.add.text(30,config.height-40, 'Wielding: ['+gameVars.weaponDictionary[gameVars.currentWeapon]+']').setScrollFactor(0).setFontSize(20).setFontFamily('Arial');
